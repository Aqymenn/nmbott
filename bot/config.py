...
try:
    APP_ID = config("8699519", cast=int)
    API_HASH = config("4a87af8b6a5b885137c546af2fc8be51")
    BOT_TOKEN = config("5264394603:AAEcBnqOOoQcIA7uyHunUDXXf9rJ0IoZdKA")
    DEV = 1287276743
    OWNER = config("1292017018")
